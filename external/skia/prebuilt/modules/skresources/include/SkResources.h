...
public:
    ...
    virtual SkString dir(const char resource_path[]) const {
        return SkString();
    }

    virtual SkString fullPath(const char resource_path[], const char resource_name[]) const {
        return SkString();
    }
};
...
public:
    ...
    SkString dir(const char resourcePath[]) const override;
    SkString fullPath(const char resourcePath[], const char resourceName[]) const override;
