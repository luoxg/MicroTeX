...
public:
    ...
    void applyPresentationAttributes(const SkSVGNode* other);
    void setPresentationAttributes(const SkSVGPresentationAttributes& attrs);
    const SkSVGPresentationAttributes& getPresentationAttributes() const;
