...
public:
    ...
    SkSVGFeFuncType() : fType(Type::kUnspecified) {}
    explicit SkSVGFeFuncType(Type t) : fType(t) {}

    bool operator==(const SkSVGFeFuncType& other) const {
        return fType == other.fType;
    }
    bool operator!=(const SkSVGFeFuncType& other) const { return !(*this == other); }
...
public:
    ...
    constexpr SkSVGOverflow() : fType(Type::kDefault) {}
    constexpr explicit SkSVGOverflow(Type t) : fType(t) {}

    SkSVGOverflow(const SkSVGOverflow&)            = default;
    SkSVGOverflow& operator=(const SkSVGOverflow&) = default;

    bool operator==(const SkSVGOverflow& other) const { return fType == other.fType; }
    bool operator!=(const SkSVGOverflow& other) const { return !(*this == other); }
