...
public:
    ...
    SkScalar resolve(const SkSVGLength&, LengthType, const SkScalar upem = 16) const;
    SkRect   resolveRect(const SkSVGLength& x, const SkSVGLength& y,
                         const SkSVGLength& w, const SkSVGLength& h,
                         const SkScalar upem = 16) const;
...
public:
    ...
    SkSVGRenderContext(SkCanvas*, const sk_sp<SkFontMgr>&,
                       ...
                       const SkSVGIDMapper&, const SkSVGDOMMapper&,
                       const SkSVGLengthContext&, const SkSVGPresentationContext&,
                       const OBBScope&, const SkScalar upem = 16);
    ...
    void applyPresentationAttributes(const SkSVGNode* node);
    ...
    sk_sp<SkSVGDOM> findRemoteDomByPath(const SkString& path) const;
    ...
    const SkScalar upem() const { return fUpem; }
...
private:
    ...
    void resolveUpem(const SkSVGNode* node);
    ...
    const SkSVGDOMMapper&                         fDOMMapper;
